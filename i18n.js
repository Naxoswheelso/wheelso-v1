...
(function (global) {
  ...
  var I18N = {
    ...
    pricesUnavailable_title: { en: "Prices couldn't load", el: 'Δεν φορτώθηκαν οι τιμές' },
    pricesUnavailable_body:  { en: 'We could not load live prices right now. Please check your connection and try again.',
                       el: 'Δεν μπορέσαμε να φορτώσουμε τις τιμές αυτή τη στιγμή. Ελέγξτε τη σύνδεσή σας και δοκιμάστε ξανά.' },
    pricesUnavailable_retry: { en: 'Try again',        el: 'Δοκιμάστε ξανά' },
    ...
    // "€{amount} prepayment after confirmation"
    depositAfterConfirm: { en: '€{amount} prepayment after confirmation',
    ...
    payLaterDesc:    { en: 'Pay 10% now as a prepayment, the rest at the counter. Cancel anytime — the 10% is non-refundable.',
    ...
    cancelPayLater:  { en: 'Pay Later — 10% prepayment, balance at counter',
    ...
    sum_rate_flex:      { en: 'Pay Later · 10% prepayment + balance at counter',
                          el: 'Πληρωμή αργότερα · 10% προκαταβολή + υπόλοιπο στο γραφείο' },
    ...
    ic_depositAfterConfirm:{ en: 'Prepayment after confirmation',  el: 'Προκαταβολή μετά την επιβεβαίωση' },
    ...
    ic_payNothingToday:    { en: 'Nothing today — prepayment on confirmation, balance at counter',
    ...
    ic_payTodayDeposit:    { en: 'Pay today (10% prepayment)', el: 'Πληρωμή σήμερα (προκαταβολή κράτησης)' },
    ic_atPickupBalance:    { en: 'At pick-up (balance)',        el: 'Στην παραλαβή (υπόλοιπο)' },
    ic_depositNowBalance:  { en: '10% prepayment now · 90% balance at counter',
    ...
    ic_flexibleCancel:     { en: 'Flexible — cancel anytime, prepayment non-refundable',
                             el: 'Ευέλικτο — ακύρωση οποτεδήποτε, η προκαταβολή δεν επιστρέφεται' },
    ic_cancelAnytime:      { en: 'Cancel anytime, even at the last minute. Your 10% prepayment is non-refundable, but you owe nothing more.',
    ...
    ic_cancelAnytimeFlex:  { en: 'Cancel anytime, even at the last minute. Your prepayment of <strong>€{deposit}</strong> is <span class="warn">non-refundable</span>, but you owe nothing else.',
